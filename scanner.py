  ...
  <body>
    <div class="shell">
      ...
      <footer>
        <div class="footer-left">
          ...
          <span>Block Size: 512 bytes</span>
    ...
    <script>
      ...
      function startAnalysis() {
        ...
        // Build URL params to pass session context to the dashboard
        const filename = document.getElementById("fileName").textContent || "";
        const size = document.getElementById("fileSize").textContent || "";
        const sha256 = document.getElementById("fileHash").textContent || "";
        ...
        // Navigate to analysis dashboard — passes all context in URL
        window.location.href = `analysis_dashboard.html?${params.toString()}`;
      }
